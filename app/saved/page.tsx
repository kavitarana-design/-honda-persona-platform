  ...
  return (
    <div className="flex flex-col gap-3.5 rounded-[14px] border border-[#E8E8EA] bg-white p-[18px] shadow-[0_1px_2px_#18181B0D]">
      ...
      <div className="flex items-center gap-2.5 border-t border-[#F0F0F1] pt-3.5">
        ...
        <Link href="/orchestration" className="flex items-center gap-[7px] rounded-[9px] border border-[#E4E4E7] bg-white px-3.5 py-2 text-[13px] font-semibold text-[#52525B] transition-colors hover:bg-[#FAFAFA]">
      ...
      <div className="bg-app flex-1 overflow-y-auto">
        <div className="mx-auto flex w-full max-w-[900px] flex-col gap-4 px-8 py-7">
          ...
          <div className="flex items-start gap-3">
            ...
            <Link href="/orchestration" className="flex shrink-0 items-center gap-[7px] rounded-[9px] bg-[#CC0000] px-4 py-2 text-[13px] font-semibold text-white transition-colors hover:bg-[#B8041A]">
